    ...
    <div className="m-6 flex flex-col gap-1 border-t border-white/50 px-4 pt-6 tracking-wide text-white">
      ...
      <div className="inline-flex flex-col items-center justify-between gap-1 font-[Prod-light] sm:flex-row">
        <div>
          ...
          <span> & </span>
          <a href={"https://github.com/AidanWarner97"} target="_blank" rel="noreferrer">
            <span className="font-[Prod-bold] text-sm underline">Aidan Warner</span>
          </a>
        </div>
        <div className="">
          Developed by{" "}
          ...
          <span> & </span>
          <a
            href={"https://github.com/AidanWarner97"}
            target="_blank"
            rel="noreferrer"
          >
            <span className="font-[Prod-bold] underline">Aidan Warner</span>
          </a>
        </div>
      </div>
    </div>
